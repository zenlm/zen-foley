...
\begin{abstract}
Video-to-audio Foley generation.
\end{abstract}
...
\begin{itemize}
    \item Video-to-audio synthesis
    \item 48kHz professional audio
    \item Multi-scenario sync
    \item Natural sound effects
\end{itemize}
